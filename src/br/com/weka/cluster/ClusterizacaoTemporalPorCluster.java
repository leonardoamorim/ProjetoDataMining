...
public class ClusterizacaoTemporalPorCluster {
    ...
    public void criarArquivo(List<Estatistica> lista, int posicao) throws IOException{
    	...
    	for (int i=0; i < lista.size(); i++) {
    	  ...
    	  try {  
              FileOutputStream oStream = new FileOutputStream(manip.getDiretorioClustersEspaciais()+"clusterizacao_espacial"+posicao+".arff"); // ou usando um File com argumento  
	...
	public void iniciarRanking() throws IOException {
